...
const Footer = () => {
  const linkCss =
    "text-gray-600 transition-colors duration-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500";
  return (
    <>
      <div className="container mx-auto px-4 max-w-7xl py-16">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
          ...
          <div>
            <p className="font-semibold">F.A.Q.</p>
        ...
        <div className="flex items-center justify-between">
          <p className="text-gray-600">
            Copyright © 2024 Tatsulok. All rights reserved.
          </p>
